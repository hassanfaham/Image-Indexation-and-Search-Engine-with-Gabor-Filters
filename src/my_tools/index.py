...
def index1(params):
	...
	c = 1
	all_files = os.listdir('D:\\Work\\Master\\S3\\Analyse, Mining and Indexing\\Testp\\src\\static\\images\\')  ##path relative to server.py
	...
	for imagePath in all_files:
		...
		image = cv2.imread("D:\\Work\\Master\\S3\\Analyse, Mining and Indexing\\Testp\\src\\static\\images\\"+imagePath)
